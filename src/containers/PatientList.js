    ...
    <div className="ListingPage">
            ...
            <h2>Please pick a status:</h2>
             <Form.Item>
					<Select defaultValue="Patient Status"  onChange={handleChange}>
						<Option value="Referral Received/For Triage">Referral Received/For Triage</Option>
                        ...
                        <Option value="Results Interpreted by Physician">Results Interpreted by Physician</Option>
                        <Option value="Study Follow-up booked">Study Follow-up booked</Option>
                        <Option value="Follow-up complete">Follow-up Complete</Option>
                        <Option value="Treatment Follow-up Booked">Treatment Follow-up Booked</Option>
                        <Option value="Treatment Follow-up Complete">Treatment Follow-up Complete</Option>
					</Select>
		        </Form.Item>
        </div>
        <div className="ListedPatients">
            ...
            <div className="NumberOfItems">
             ...
             <div className="Table">
             <Table columns={columns} dataSource={data} pagination={{ position: 'bottom'}, { alignment: 'centre'}}/>;
            </div>
        </div>
</div>
        )
